...
interface FullImgPageProps {
  setShow: React.Dispatch<React.SetStateAction<boolean>>;
}

const FullImgPage: React.FC<FullImgPageProps> = ({ setShow }) => {
  ...
  return (
    <div className="fixed top-0 left-0 z-50 bottom-0 lg:flex h-screen w-screen bg-[--black] text-[--light]">
