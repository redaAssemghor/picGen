...
const Footer = () => {
  ...
  return (
    <footer className="text-[--light] pb-4 lg:px-40 overflow-hidden">
      <div className="relative flex flex-col lg:flex-row lg:items-end justify-between items-center">
        <Particles
        ...
        <div className="flex flex-col items-center w-full">
          <Image
            ...
            alt="footer astro"
          />
          <nav className="flex gap-6 lg:hidden">
            <a>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
